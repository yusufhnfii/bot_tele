 ...
 if (process.argv.length < 5){console.log(gradient.instagram(`(BOMB) @estehhhh<By-LITE-TEAM>Host Time Rps Tread`)); process.exit();}
 ...
 if (cluster.isMaster) {
    ...
    console.log(gradient.instagram(`[Broadcast] Status: Succes!`));
